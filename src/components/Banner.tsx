    ...
    <section className='py-18'>
      <div className='container mx-auto items-center grid grid-cols-2'>
        ...
        <div className='place-items-start'>
          <h1 className='text-5xl font-black'>Build Your Ideal
          ...
          next project.</p>
          <div className='grid grid-cols-2 gap-5 my-17'>
                  <button className='p-2 rounded-md bg-linear-to-r from-[#F97316] from-0% to-[#EC4899] to-100%'>Explore Technologies</button>
