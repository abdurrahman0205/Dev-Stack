    ...
    <section>
      <div className="container mx-auto mb-15 text-[#64748B]">
        <div className="text-left">
          <h1 className="text-3xl font-bold text-[#0F172A]">Explore the <span className="bg-linear-to-r from-[#EC4899] from-10% to-[#8B5CF6] to-100% text-transparent bg-clip-text ">Technologies</span></h1>
